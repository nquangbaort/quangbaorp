...
<div class="min-h-screen flex flex-col">
    ...
    <!-- Text Header -->
    <blog-header :subtitle="`Category : ${categoryName}`"></blog-header>
...
export default {
	...
	methods: {
		async getPostData(page=1) {
			...
			if(res.status==200){
				this.sortedByCategory = res.data.posts.data; // get paginated data
				this.categoryName = res.data.categoryName; // get paginated data
